...
public class Main {
    public static void main(String[] args) {
        ...
        students.add(new Student("Петров Артем Владимирович", "1234567890", 4.5));
        students.add(new Student("Иванов Иван Иванович", "9876543210", 4.8));
        students.add(new Student("Думанов Ислам Юрьевич", "1357924680", 3.2));
